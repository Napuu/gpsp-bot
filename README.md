...
For yle.fi links, if [yle-dl](https://aajanki.github.io/yle-dl/) is available in `PATH`, it will be used first. If yle-dl fails or is not available, the bot automatically falls back to yt-dlp.
